...
bool TrajectoryGenerator::generateFirstTrajectories(const iDynTree::Position& initialRobotPosition)
{
    ...
    m_desiredPoint(0) = m_referencePointDistance(0) + initialRobotPosition(0);
    m_desiredPoint(1) = m_referencePointDistance(1) + initialRobotPosition(1);
