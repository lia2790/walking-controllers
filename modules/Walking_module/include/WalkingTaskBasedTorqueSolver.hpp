...
protected:
    ...
    virtual bool instantiateCoMAsLinearMomentumConstraint(const yarp::os::Searchable& config) = 0;
...
private:
    ...
    bool instantiateCoMAsLinearMomentumConstraint(const yarp::os::Searchable& config) override;
